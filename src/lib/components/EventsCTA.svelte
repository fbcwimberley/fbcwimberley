<section class="relative py-24 bg-cover bg-center bg-fixed" style="background-image: url('/images/remote/fbcwimberley.com-102A0963-scaled-283b05ccc9-960.webp')">
