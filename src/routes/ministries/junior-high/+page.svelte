<svelte:head>
	<title>Junior High - First Baptist Church Wimberley</title>
</svelte:head>
...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden">
	...
	<div class="relative z-1 text-center px-6">
		...
		<h1 class="text-[clamp(2.4rem,6vw,4rem)] text-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.28)]">Junior High</h1>
	</div>
</section>
	...
	<div class="container max-w-none px-0">
		<div class="grid grid-cols-1 lg:grid-cols-12">
			<div class="lg:col-span-5 bg-[#89cddc] p-8 md:p-12 lg:p-16 flex flex-col justify-center text-black">
				<h3 class="text-[clamp(1.5rem,3vw,2.1rem)] mb-4 text-black">A Place to Belong</h3>
				<p class="leading-[1.75] mb-6 text-black">Join us in the student building as we break into small groups to dive into God&apos;s word.</p>
				<p class="font-semibold mb-1 text-black">Sundays</p>
				<p class="text-black mb-3">9:30 am</p>
				<p class="font-semibold mb-1 text-black">Wednesdays</p>
