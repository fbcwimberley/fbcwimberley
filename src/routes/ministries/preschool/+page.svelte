	...
	<div class="container max-w-[1100px]">
		<div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
			<div class="lg:col-span-5 rounded-[var(--radius-lg)] border border-(--color-border-light) bg-(--color-bg-card) p-7 md:p-9">
				<h2 class="text-[clamp(1.5rem,3vw,2rem)] mb-4">First Look</h2>
	...
	<div class="container max-w-[1100px]">
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
			<div class="rounded-[var(--radius-lg)] border border-(--color-border-light) bg-(--color-bg-card) p-6">
				...
				<p class="text-(--color-text-muted) leading-[1.75]">We want your littlest ones to feel safe and at ease, so we do everything we can to ensure that you and your child feel comfortable. Please let us know if your child has any specific needs. This will help us make their time with us the best it can be.</p>
			</div>
			<div class="rounded-[var(--radius-lg)] border border-(--color-border-light) bg-(--color-bg-card) p-6">
				<h3 class="text-[1.25rem] mb-3">Toddlers</h3>
				<p class="text-(--color-text-muted) leading-[1.75]">Children will meet in a circle each week in their classrooms and learn about God in meaningful and developmentally appropriate ways through hands-on activities.</p>
			</div>
			<div class="rounded-[var(--radius-lg)] border border-(--color-border-light) bg-(--color-bg-card) p-6">
				<h3 class="text-[1.25rem] mb-3">Pre-K</h3>
				<p class="text-(--color-text-muted) leading-[1.75]">Children will meet in a circle each week and also participate in a large group environment, called the Playhouse, for Bible story and worship.</p>
			</div>
		</div>
	</div>
</section>
